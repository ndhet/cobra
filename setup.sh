...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/Romba89/ssh-xray-wss/aio/permission/ip > /root/tmp
...
# https://raw.githubusercontent.com/Romba89/ssh-xray-wss/aio/permission/ip 
MYIP=$(curl -sS ipv4.icanhazip.com)
Name=$(curl -sS https://raw.githubusercontent.com/Romba89/ssh-xray-wss/aio/permission/ip | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/Romba89/ssh-xray-wss/aio/permission/ip | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/Romba89/ssh-xray-wss/aio/permission/versi  )
